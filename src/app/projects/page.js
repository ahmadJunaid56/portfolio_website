      ...
      <div className="container mx-auto py-16 px-6">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
          ...
          <div className="bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-lg shadow-lg overflow-hidden hover:scale-105 transition-transform duration-300">
            <img src="/project (1).webp" alt="Food Website" className="w-full h-56 " />
            <div className="p-6">
          ...
          <div className="bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-lg shadow-lg overflow-hidden hover:scale-105 transition-transform duration-300">
            <img src="/project (5).webp" alt="E-Commerce Website" className="w-full h-56 " />
            <div className="p-6">
          ...
          <div className="bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-lg shadow-lg overflow-hidden hover:scale-105 transition-transform duration-300">
            <img src="/project (4).webp" alt="Clinic Website" className="w-full h-56 " />
            <div className="p-6">
          ...
          <div className="bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-lg shadow-lg overflow-hidden hover:scale-105 transition-transform duration-300">
            <img src="/project (3).webp" alt="Farm Website" className="w-full h-56 " />
            <div className="p-6">
          ...
          <div className="bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-lg shadow-lg overflow-hidden hover:scale-105 transition-transform duration-300">
            <img src="/project.webp" alt="Blog Website" className="w-full h-56 " />
            <div className="p-6">
          ...
          <div className="bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-lg shadow-lg overflow-hidden hover:scale-105 transition-transform duration-300">
            <img src="/project (6).webp" alt="Travel Website" className="w-full h-56 " />
            <div className="p-6">
