      ...
      <div className="about-inner">
        <div className="aboutText" data-aos="zoom-in-right">
          ...
          <p className="paragraph-text text-justify leading-8 text-xl">
            ...
            ideas to life through clean code and innovative design solutions. I
            am always exploring the latest trends in web development to enhance
            my skills and stay ahead in the industry. Let us work together to
